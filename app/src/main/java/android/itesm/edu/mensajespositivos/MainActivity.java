package android.itesm.edu.mensajespositivos;
...
public class MainActivity extends AppCompatActivity {
    ...
    public int random = (int) (Math.random() * 118);

    private static final String TAG = "POSITIVE"; // static no es de clase y es constante
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        constraintLayout = findViewById(R.id.fondo);
        ...
        Log.i(TAG, "Welcome to the jungle");
    }
    ...
    public void ir(View view) {
        String frase_string = editText.getText().toString();
        int frase_int = Integer.parseInt(frase_string);

        if (frase_int > 117) /*||(frase_int < 0) */{
            Toast.makeText(this, "Número inválido", Toast.LENGTH_LONG).show();
        }
        textView.setText(mensajes[frase_int]);
    }

    public String[] mensajes = {"Somos lo que pensamos. Todo lo que somos surge con nuestros pensamientos. Con nuestros pensamientos construimos el mundo.-Buddha.",
